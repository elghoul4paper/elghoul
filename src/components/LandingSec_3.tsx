    ...
    <div className="dark:bg-[#0A0908] sm:pt-7 sm:pb-7">
      ...
      >
        <div className="sm:w-1/2">
          <img className="  rounded-2xl" src="slide-3.jpg" alt="" />
        </div>
        <div className="px-3 sm:w-1/2 m-auto text-center    ">
          <h1 className="dark:text-white font-[rakkas] rtl:  leading-snug  text-4xl  md:text-5xl xl:text-7xl ">
         كل خامة تغليف ممكن تحتاجها... هتلاقيها عند الغول 
          </h1>
        </div>
      </div>
    </div>
